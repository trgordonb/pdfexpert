...
def create_service_context():
    ...
    prompt_helper = PromptHelper(max_input_size, num_outputs, chunk_size_limit=chunk_size_limit, chunk_overlap_ratio=0.2)
...
def data_ingestion_indexing(directory_path):
    ...
    if pinecone_index_name not in pinecone.list_indexes():
        ...
        pinecone_index = pinecone.Index(index_name=pinecone_index_name)
        #directoryLoader = DirectoryLoader(directory_path, loader_cls=PDFPlumberLoader)
